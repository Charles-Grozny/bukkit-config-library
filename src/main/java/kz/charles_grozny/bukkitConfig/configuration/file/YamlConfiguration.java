...
import kz.charles_grozny.bukkitConfig.configuration.InvalidConfigurationException;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            System.out.println("Cannot load " + file + " | " + ex.getMessage()); // TODO: 10.09.2022 | remove sout
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
            ...
            System.out.println("Cannot load configuration from stream"); // TODO: 10.09.2022 | remove sout
